...
namespace GerenciadorDeTarefas
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication(autenticao =>
            {
                autenticao.DefaultAuthenticateScheme = JwtBearerDefaults.AuthenticationScheme;
                autenticao.DefaultChallengeScheme = JwtBearerDefaults.AuthenticationScheme;
